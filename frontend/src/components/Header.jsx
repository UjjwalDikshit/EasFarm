...
//             <li>
//               <a
//                 className="font-medium hover:bg-primary-focus rounded-btn"
//                 onClick={() => navigate("/")}
//               >
//                 Home
//               </a>
...
//             </li>
//             <li>
//               <a className="font-medium hover:bg-primary-focus rounded-btn">
//                 Pricing
//               </a>
//             </li>
//             <li>
...
//             <div
//               tabIndex={0}
//               className="card dropdown-content card-compact z-[1] mt-3 w-52 bg-base-100 shadow text-base-content"
//             >
...
//               </li>
//               <li>
//                 <a className="font-medium hover:bg-primary-focus rounded-btn block p-2">
//                   Features
//                 </a>
//               </li>
//               <li>
